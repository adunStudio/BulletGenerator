...
require("Script/Shooter/20_WavingCircleShooter")
...
function love.load()
    ...
    enemys[15] = WavingCircleShooter:New{shotAngle = 90, wavingAngleRange = 30,  shotSpeed = 7, shotCount = 6, interval = 7, cycle = 120}
